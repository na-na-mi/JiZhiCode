...
ax1.set_xlabel('');ax1.set_ylabel('Temperature');ax1.set_title('two days ago Max Temp')
# 昨天的最高温度值
...
ax3.set_xlabel('');ax3.set_ylabel('Temperature');ax3.set_title('year average Temp')
# 气象台预测
ax4.plot(dates,data['prediction'])
ax4.set_xlabel('');ax4.set_ylabel('Temperature');ax4.set_title('prediction')
